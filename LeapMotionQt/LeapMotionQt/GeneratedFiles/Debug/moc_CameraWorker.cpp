...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CameraWorker_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CameraWorker_t qt_meta_stringdata_CameraWorker = {
    {
QT_MOC_LITERAL(0, 0, 12), // "CameraWorker"
QT_MOC_LITERAL(1, 13, 14), // "killedTheTimer"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 12), // "startWorking"
QT_MOC_LITERAL(4, 42, 11), // "updateImage"
QT_MOC_LITERAL(5, 54, 12) // "killTheTimer"

    },
    "CameraWorker\0killedTheTimer\0\0startWorking\0"
    "updateImage\0killTheTimer"
};
...
void CameraWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->killedTheTimer(); break;
        case 1: _t->startWorking(); break;
        case 2: _t->updateImage(); break;
        case 3: _t->killTheTimer(); break;
        default: ;
        }
        ...
        {
            typedef void (CameraWorker::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CameraWorker::killedTheTimer)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject CameraWorker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CameraWorker.data,
      qt_meta_data_CameraWorker,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CameraWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CameraWorker.stringdata))
...
// SIGNAL 0
void CameraWorker::killedTheTimer()
{
